...
// Identify space reading helpers
...
typedef struct ide_device {
   ...
   struct ide_device* next; // To create a linked list of all IDE devices
} ide_device_t;

// Search the IDE space for controllers, probe controllers for drivessd
void ide_init();
void ide_controller_initialize(pci_device_t* pci_dev);

// Disk Function Implementations
